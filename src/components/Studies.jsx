    ...
    return (
        <div className="studies">
            ...
            <div className="estudios">
                ...
                <div className="estudio">
                    <div className="FechaLugar">
                        <div className="fecha">17/11/2006</div>
                        <div className="lugar">Chía</div>
                    </div>
                    <div className="TituloInstitucion">
                        <div className="Titulo">Secretariado Auxiliar Contable </div>
                ...
                <div className="estudio">
                    <div className="FechaLugar">
                        <div className="fecha">12/12/2003</div>
                        <div className="lugar">Zipaquirá</div>
                    </div>
                    <div className="TituloInstitucion">
                        <div className="Titulo">Bachiller Académico</div>
                        <div className="Institucion">Universidad o institución</div>
                    </div>
                    <div className="btnDescarga">
                        <a href="#">
                            <img src={ iconDwl } alt="Download" />
            ...
            <div className="estudios">
                ...
                <div className="estudio">
                    <div className="FechaLugar">
                        <div className="fecha">20/05/2017</div>
                        <div className="lugar">Bogotá</div>
                    </div>
                    <div className="TituloInstitucion">
                        <div className="Titulo">Comunicación Asertiva y efectiva en equipos de Trabajo</div>
